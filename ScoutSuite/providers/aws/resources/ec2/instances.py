...
class EC2Instances(AWSResources):
    ...
    async def _parse_instance(self, raw_instance):
        ...
        instance["id"] = id
        instance["arn"] = "arn:aws:ec2:{}.{}.instance/{}".format(
            self.region, raw_instance["OwnerId"], raw_instance["InstanceId"]
        )
        ...
        if "IamInstanceProfile" in raw_instance:
            instance["iam_instance_profile_id"] = raw_instance["IamInstanceProfile"][
                "Id"
            ]
            instance["iam_instance_profile_arn"] = raw_instance["IamInstanceProfile"][
                "Arn"
            ]
        ...
        if "IamInstanceProfile" in raw_instance:
            instance["iam_role"] = raw_instance["IamInstanceProfile"]["Arn"].split("/")[
                -1
            ]
        else:
